================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Eden プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Eden には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Eden アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Eden.h
   ...
   CEdenApp アプリケーション クラスを宣言します。

Eden.cpp
   これは、アプリケーション クラス CEdenApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Eden.ico
   ...
   アイコンはメイン リソース ファイル Eden.rc に含まれていま
   す。
...
EdenDlg.h, EdenDlg.cpp - ダイアログ
   これらのファイルは CEdenDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Eden.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Eden.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
